...
function ReviewLine({ label, value }: { label: string; value: string }) {
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '220px 1fr', gap: 10, borderBottom: '1px solid #f1f5f9', paddingBottom: 6 }}>
...
function PhotoUploader({ onUpload }: { onUpload: (file: File | null, caption: string) => Promise<void> }) {
  ...
  return (
    <div style={{ display: 'grid', gap: 8, gridTemplateColumns: 'minmax(200px, 1fr) minmax(240px, 1fr)', marginBottom: 8 }}>
