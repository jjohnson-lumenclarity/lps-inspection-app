...
const icons = {
  ...
  forms: <IconBase><path d="M6 3h9l5 5v13H6z" /><path d="M15 3v5h5" /><path d="M9 13h8" /><path d="M9 17h8" /></IconBase>,
  summary: <IconBase><path d="M5 4h14v16H5z" /><path d="M8 8h8" /><path d="M8 12h8" /><path d="M8 16h5" /></IconBase>,
  review: <IconBase><path d="M3 5h18v14H3z" /><path d="m8.5 10 2 2 4-4" /></IconBase>,
...
export default function Sidebar() {
  ...
  const menuItems: MenuItem[] = [
    ...
    { label: 'Inspection Prep', href: '/inspections', icon: icons.inspections },
    { label: 'Checklist', href: '/checklist', icon: icons.checklist },
    { label: 'Quote Summary', href: '/quote-summary', icon: icons.summary },
    { label: 'Review Queue', href: '/review', icon: icons.review },
