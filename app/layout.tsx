...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className="font-['Inter'] antialiased" style={{ paddingLeft: '104px', fontFamily: 'Inter, ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif' }}>
        <Sidebar />
        {children}
      </body>
    </html>
