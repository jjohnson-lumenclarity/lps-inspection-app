...
export default function QuoteSummaryPage() {
  ...
  return (
    <main style={{ minHeight: '100vh', padding: '96px 24px 28px 24px', fontFamily: 'Inter, sans-serif', background: '#f8fafc' }}>
      <style>{`@media print { aside, nav, button, .hide-print, img[alt="Inspection company logo"] { display: none !important; } main { padding: 0 !important; margin: 0 !important; background: #fff !important; } .print-card { box-shadow: none !important; border: 1px solid #e2e8f0 !important; break-inside: avoid; } }`}</style>
      <div style={{ maxWidth: '1120px', margin: '0 auto', display: 'grid', gap: '14px' }}>
        <section className="print-card" style={{ background: '#fff', border: '1px solid #dbe3ea', borderRadius: '14px', padding: '18px', boxShadow: '0 8px 24px rgba(15,23,42,0.08)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr auto auto', gap: '10px', alignItems: 'end' }}>
            <div>
              ...
              <select value={selectedProjectId} onChange={(e) => setSelectedProjectId(e.target.value)} style={{ width: '100%', border: '1px solid #cbd5e1', borderRadius: '8px', padding: '10px 12px' }}>
                {projects.map((item) => (
        ...
        {project && !loadingSummary && (
          <>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: '12px' }}>
                <div style={{ display: 'grid', gap: '10px' }}>
                  <label style={{ fontWeight: 600, color: '#334155' }}>Company Name
                    <input value={project.title} onChange={(e) => setProject({ ...project, title: e.target.value })} style={{ display: 'block', width: '100%', marginTop: '5px', border: '1px solid #cbd5e1', borderRadius: '8px', padding: '9px 10px' }} />
                  </label>
                  <label style={{ fontWeight: 600, color: '#334155' }}>Address
                    <input value={project.address} onChange={(e) => setProject({ ...project, address: e.target.value })} style={{ display: 'block', width: '100%', marginTop: '5px', border: '1px solid #cbd5e1', borderRadius: '8px', padding: '9px 10px' }} />
                  </label>
                  <label style={{ fontWeight: 600, color: '#334155' }}>Description
                    <textarea value={project.description || ''} onChange={(e) => setProject({ ...project, description: e.target.value })} rows={3} style={{ display: 'block', width: '100%', marginTop: '5px', border: '1px solid #cbd5e1', borderRadius: '8px', padding: '9px 10px' }} />
                  </label>
                </div>
                <div style={{ display: 'grid', gap: '10px' }}>
                  <label style={{ fontWeight: 600, color: '#334155' }}>Project Status
                    <select value={project.status} onChange={(e) => setProject({ ...project, status: e.target.value })} style={{ display: 'block', width: '100%', marginTop: '5px', border: '1px solid #cbd5e1', borderRadius: '8px', padding: '9px 10px' }}>
                  ...
                  <label style={{ fontWeight: 600, color: '#334155' }}>Contact Name
                    <input value={projectMeta.contactName} onChange={(e) => setProjectMeta({ ...projectMeta, contactName: e.target.value })} style={{ display: 'block', width: '100%', marginTop: '5px', border: '1px solid #cbd5e1', borderRadius: '8px', padding: '9px 10px' }} />
                  </label>
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
                    <label style={{ fontWeight: 600, color: '#334155' }}>Phone
                      <input value={projectMeta.phone} onChange={(e) => setProjectMeta({ ...projectMeta, phone: e.target.value })} style={{ display: 'block', width: '100%', marginTop: '5px', border: '1px solid #cbd5e1', borderRadius: '8px', padding: '9px 10px' }} />
                    </label>
                    <label style={{ fontWeight: 600, color: '#334155' }}>Email
                      <input value={projectMeta.email} onChange={(e) => setProjectMeta({ ...projectMeta, email: e.target.value })} style={{ display: 'block', width: '100%', marginTop: '5px', border: '1px solid #cbd5e1', borderRadius: '8px', padding: '9px 10px' }} />
                    </label>
                  </div>
                </div>
              </div>
            ...
            <section className="print-card" style={{ background: '#fff', border: '1px solid #dbe3ea', borderRadius: '14px', padding: '18px', boxShadow: '0 8px 24px rgba(15,23,42,0.08)' }}>
              <h2 style={{ marginTop: 0, color: '#0f172a' }}>Checklist & Overall Notes</h2>
              {checklistItems.length === 0 ? (
                <p style={{ margin: 0, color: '#64748b' }}>No checklist saved yet for this project.</p>
              ) : (
                <div style={{ display: 'grid', gap: '8px' }}>
                  {checklistItems.map((item) => (
                    <div key={item.key} style={{ display: 'flex', justifyContent: 'space-between', border: '1px solid #e2e8f0', borderRadius: '8px', padding: '8px 10px' }}>
              ...
              <div style={{ marginTop: '12px' }}>
                <label style={{ fontWeight: 600, color: '#334155' }}>Overall Notes
                  <textarea
                    ...
                    rows={4}
                    style={{ display: 'block', width: '100%', marginTop: '5px', border: '1px solid #cbd5e1', borderRadius: '8px', padding: '9px 10px' }}
                  />
                </label>
              </div>
            </section>
            ...
            <section className="print-card" style={{ background: '#fff', border: '1px solid #dbe3ea', borderRadius: '14px', padding: '18px', boxShadow: '0 8px 24px rgba(15,23,42,0.08)' }}>
              <h2 style={{ marginTop: 0, color: '#0f172a' }}>Zones, Notes & Photos</h2>
                  ...
                  <article key={zone.id} style={{ border: '1px solid #e2e8f0', borderRadius: '12px', padding: '10px' }}>
                    ...
                    <label style={{ fontWeight: 600, color: '#334155' }}>Zone Notes
                      <textarea
                        ...
                        rows={3}
                        style={{ display: 'block', width: '100%', marginTop: '5px', border: '1px solid #cbd5e1', borderRadius: '8px', padding: '8px 9px' }}
                      />
                    </label>
