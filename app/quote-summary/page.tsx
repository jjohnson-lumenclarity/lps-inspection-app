...
export default function QuoteSummaryPage() {
  ...
  return (
    <main style={{ minHeight: '100vh', padding: '96px 16px 28px calc(var(--sidebar-width, 88px) + 16px)', fontFamily: 'Inter, sans-serif', background: '#f8fafc' }}>
      ...
      .overview-left, .overview-right-card { border: 1px solid #e2e8f0; border-radius: 10px; padding: 12px; background: #fcfdff; }
      .overview-right-stack { display:grid; gap:10px; }
      ...
      @media (min-width: 1024px) { .overview-grid { grid-template-columns: minmax(0,1.1fr) minmax(0,1fr); } .two-col { grid-template-columns: 1fr 1fr; } }
      @media print {
          ...
          <>
            <section className="print-card" style={{ background: '#fff', border: '1px solid #dbe3ea', borderRadius: '14px', padding: '18px', boxShadow: '0 8px 24px rgba(15,23,42,0.08)' }}>
              ...
              <div className="overview-grid">
                <div className="overview-left" style={{ display: 'grid', gap: '10px' }}>
                  ...
                  <label style={{ fontWeight: 600, color: '#334155' }}>Description
                    <textarea value={project.description || ''} onChange={(e) => setProject({ ...project, description: e.target.value })} rows={5} className="field-input" />
                  </label>
                </div>

                <div className="overview-right-stack">
                  <div className="overview-right-card" style={{ display: 'grid', gap: '10px' }}>
