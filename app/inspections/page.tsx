...
export default function InspectionPrepPage() {
  ...
  return (
    <div style={{ padding: 24, background: '#f8fafc', minHeight: '100vh' }}>
      <header style={{ border: '1px solid #e2e8f0', borderRadius: 16, background: '#fff', padding: 24, boxShadow: '0 1px 2px rgba(15,23,42,.06)', display: 'grid', gap: 12 }}>
        ...
        <div style={{ marginTop: 12, display: 'grid', gridTemplateColumns: 'minmax(220px, 1fr) repeat(3, minmax(56px, auto))', gap: 10, alignItems: 'center' }}>
          ...
          <div style={{ ...inputStyle, textAlign: 'center', width: '100%', minWidth: 0 }}>{mapZoom}</div>
      ...
      <div style={{ marginTop: 18, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 16, alignItems: 'start' }}>
        <BuildingCanvas
